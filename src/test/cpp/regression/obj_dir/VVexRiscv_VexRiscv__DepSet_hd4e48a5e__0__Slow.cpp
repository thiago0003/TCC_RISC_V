...
VL_ATTR_COLD void VVexRiscv_VexRiscv___settle__TOP__VexRiscv__2(VVexRiscv_VexRiscv* vlSelf) {
    ...
    __PVT__execute_LightShifterPlugin_shiftInput = 
        ((IData)(vlSelf->__PVT__execute_LightShifterPlugin_isActive)
    ...
    vlSelf->__PVT__execute_LightShifterPlugin_amplitude 
        = (0x1fU & ((IData)(vlSelf->__PVT__execute_LightShifterPlugin_isActive)
                     ? (IData)(vlSelf->__PVT__execute_LightShifterPlugin_amplitudeReg)
                     : vlSelf->__PVT___zz_execute_SRC2_4));
